...
const MenuBar = ({ editor }: { editor: Editor | null }) => {
  ...
  return (
    <div className='flex flex-wrap border p-2 gap-x-8 gap-y-4'>
      <TooltipProvider>
        {/* Word */}
        ...
        <div className='rich-editor-group'>
          <Tooltip>
            ...
            >
              ...
              >
                <ListIcon strokeWidth='1.5px' size={20} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Bullet list</p>
          ...
          <Tooltip>
            ...
            >
              ...
              >
                <ListOrderedIcon strokeWidth='1.5px' size={20} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Ordered list</p>
        ...
        <div className='rich-editor-group'>
          <Tooltip>
            ...
            >
              ...
              >
                <CuboidIcon strokeWidth='1.5' size={18} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Code block</p>
          ...
          <Tooltip>
            ...
            >
              ...
              >
                <QuoteIcon strokeWidth='1.5' size={18} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Block quote</p>
          ...
          <Tooltip>
            ...
            >
              <button
                ...
                className='flex items-center justify-center'
              >
                <MinusIcon strokeWidth='1.5' size={20} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Horizontal line</p>
        ...
        <div className='rich-editor-group'>
          <Tooltip>
            ...
            >
              ...
              >
                <AlignLeftIcon strokeWidth='1.5' size={20} />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Text align left</p>
          ...
          >
            <AlignCenterIcon strokeWidth='1.5' size={20} />
          </button>
          <button
            type='button'
          ...
          >
            <AlignJustifyIcon strokeWidth='1.5' size={20} />
          </button>
          <button
            type='button'
          ...
          >
            <AlignRightIcon strokeWidth='1.5' size={20} />
          </button>
        </div>
        {/* Undo Redo */}
        <div className='rich-editor-group'>
          ...
          >
            <Undo2Icon strokeWidth='1.5' size={20} />
          </button>
          <button
            type='button'
          ...
          >
            <Redo2Icon strokeWidth='1.5' size={20} />
          </button>
        </div>
      </TooltipProvider>
    </div>
